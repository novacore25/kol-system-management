...
### Community 20 - "CreatorRegistrationForm.tsx"
Cohesion: 0.13
...
### Community 29 - "react"
Cohesion: 0.07
Nodes (24): nextConfig, clsx, @heroui/react, lucide-react, next, react, inter, metadata (+16 more)
...
- **Why does `react` connect `react` to `package.json`, `CreatorRegistrationForm.tsx`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `drizzle-orm` connect `package.json` to `schema.ts`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `lucide-react` connect `react` to `package.json`, `CreatorRegistrationForm.tsx`?**
